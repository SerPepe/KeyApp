        ...
        <section className="engine-section">
            <div className="engine-grid">
                ...
                <div className="engine-text">
                    ...
                    >
                        "True privacy should not have a subscription fee. The Key Protocol is sustained by the <span className="accent">$KEY</span> token on the Pump.fun network.
                        We utilize the creator fees generated by $KEY volume to subsidize gas costs for every message sent on the network. By holding $KEY, you are not just an investor; you are a Patron of privacy."
                    </motion.blockquote>

                    <motion.div
                        className="data-ticker mono"
                    ...
                    >
                        <div className="ticker-item">
                            <span className="signal">●</span> Gas Tank Status: <span className="signal">Funded</span>
                        </div>
                        <div className="ticker-item">
                            Messages Subsidized: 14,203
                        </div>
                        <div className="ticker-item">
                            Current Fee Reserves: 42 SOL
                        </div>
                    </motion.div>
                </div>
            </div>
...
function MechanismDiagram() {
    return (
        ...
        >
            ...
            />
            <text x="75" y="155" fill="var(--accent)" className="mono" style={{ fontSize: '14px' }}>$KEY</text>
