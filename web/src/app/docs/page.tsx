                    ...
                    <section id="sustainability" className="mb-32">
                        ...
                        <div className="space-y-8">
                            ...
                            <p className="opacity-80 leading-relaxed">
                                The Key Protocol is a native Solana protocol. Every whisper, every registry update, and every signal is a permanent, on-chain record on the Solana blockchain. We don't hide behind sidechains; we leverage the raw performance of the mainnet.
                            </p>
