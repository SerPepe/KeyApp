                    ...
                    <section id="sustainability" className="mb-32">
                        ...
                        <div className="space-y-8">
                            <p className="font-serif italic text-2xl leading-relaxed text-[var(--accent)] opacity-90 border-l-2 border-[var(--accent)] pl-8">
                                "True privacy should not have a subscription fee. The Key Protocol is sustained by the $KEY token on Bags.fm. We utilize the creator fees generated by $KEY volume to subsidize gas costs for every message sent on the network. By holding $KEY, you are not just an investor; you are a Patron of privacy."
                            </p>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="p-6 bg-[rgba(255,255,255,0.02)] border border-white/5">
                                    ...
                                    <p className="text-xl font-serif">Bags.fm</p>
                                </div>
                            </div>
                        </div>
                    </section>
